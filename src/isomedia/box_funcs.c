...
} box_registry [] =
{
	...
	BOX_DEFINE_S( GF_ISOM_BOX_TYPE_VVC1, video_sample_entry, "stsd", "p15"),
	BOX_DEFINE_S( GF_ISOM_BOX_TYPE_VVI1, video_sample_entry, "stsd", "p15"),
	...
	BOX_DEFINE_S( GF_ISOM_BOX_TYPE_MLPA, audio_sample_entry, "stsd", "dolby"),
